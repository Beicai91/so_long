...
void	move_up(t_data *data, int keycode)
{
	...
	{
		if (data->map_data.map[data->player_pos.y
			- 1][data->player_pos.x] == '0'
			|| data->map_data.map[data->player_pos.y
			- 1][data->player_pos.x] == 'P'
			|| data->map_data.map[data->player_pos.y
			- 1][data->player_pos.x] == 'B'
			|| data->map_data.map[data->player_pos.y
			- 1][data->player_pos.x] == 'J')
		{
			mlx_put_image_to_window(data->mlxdata.mlx, data->mlxdata.win,
			...
			if (!(data->player_pos.x == data->door_pos.x
				...
				mlx_put_image_to_window(data->mlxdata.mlx, data->mlxdata.win,
					data->sprites.floor, data->player_pos.x * SIZE,
		...
		else if (data->map_data.map[data->player_pos.y
			- 1][data->player_pos.x] == 'C')
		{
			mlx_put_image_to_window(data->mlxdata.mlx, data->mlxdata.win,
				data->sprites.floor, data->player_pos.x * SIZE,
				(data->player_pos.y - 1) * SIZE);
...
void	move_left(t_data *data, int keycode)
{
	...
	{
		if (data->map_data.map[data->player_pos.y][data->player_pos.x
			- 1] == '0'
			|| data->map_data.map[data->player_pos.y][data->player_pos.x
			- 1] == 'P'
			|| data->map_data.map[data->player_pos.y][data->player_pos.x
			- 1] == 'B'
			|| data->map_data.map[data->player_pos.y][data->player_pos.x
		...
		else if (data->map_data.map[data->player_pos.y][data->player_pos.x
			- 1] == 'C')
		{
			mlx_put_image_to_window(data->mlxdata.mlx, data->mlxdata.win,
				data->sprites.floor, (data->player_pos.x - 1) * SIZE,
				data->player_pos.y * SIZE);
			mlx_put_image_to_window(data->mlxdata.mlx, data->mlxdata.win,
				data->sprites.mouse_left, (data->player_pos.x - 1) * SIZE,
				data->player_pos.y * SIZE);
